...
@CrossOrigin(origins = "*") // Allow any source/origin (temporary during dev)
public class CustomerController {
    ...
    public ResponseEntity<CustomerDTO> getCustomerByCustomerName(@PathVariable String customerName) {
